...
public class CombinationOfRotationsIn3D : MonoBehaviour
{
    ...
    {
        float cosAa = Mathf.Cos(90 * Mathf.Deg2Rad);
        float sinAa = Mathf.Sin(90 * Mathf.Deg2Rad);
        float sinBb = Mathf.Sin(90 * Mathf.Deg2Rad);
        float cosBb = Mathf.Cos(90 * Mathf.Deg2Rad);
        ...
        //   0   sin   cos   0
        //   0     0     0   1
         cosAa = Mathf.Cos(180 * Mathf.Deg2Rad);
         sinAa = Mathf.Sin(180 * Mathf.Deg2Rad);
         sinBb = Mathf.Sin(180 * Mathf.Deg2Rad);
         cosBb = Mathf.Cos(180 * Mathf.Deg2Rad);

        X2.matrix[0, 0] = 1;
        X2.matrix[3, 3] = 1;

        X2.matrix[1, 1] = cosAa;
        X2.matrix[1, 2] = sinAa * (-1);
        X2.matrix[2, 1] = sinBb;
        X2.matrix[2, 2] = cosBb;
        ...
        //   0     0  0  1
         ...
         cosAa = Mathf.Cos(30 * Mathf.Deg2Rad);
         sinAa = Mathf.Sin(30 * Mathf.Deg2Rad);
         sinBb = Mathf.Sin(30 * Mathf.Deg2Rad);
         cosBb = Mathf.Cos(30 * Mathf.Deg2Rad);

        X4.matrix[2, 2] = 1;
        X4.matrix[3, 3] = 1;

        X4.matrix[0, 0] = cosAa;
        X4.matrix[0, 1] = sinAa * (-1);
        X4.matrix[1, 0] = sinBb;
        X4.matrix[1, 1] = cosBb;
